...
public class Qinqichaxun  extends AppCompatActivity implements View.OnClickListener {


    private Spinner spinner1;
    private HashMap<String,String> cx ;
    private TextView text,text2;
    private Button  baba ,mama,xiong,jie,mei,di,fu,qi,zi,nv,de,dengyu,sc,fh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_qqgx);
        ...
        try {
            switch (v.getId()){
                ...
                case R.id.nv:
                    ...
                    break;
                case R.id.fh:
                    Intent intent = new Intent(Qinqichaxun.this,MainActivity.class);
